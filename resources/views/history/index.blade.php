                                ...
                                @forelse ($sales as $sale)
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            @endphp
                                            <span
                                                class="{{ $statusClass }} text-xs font-medium px-2.5 py-0.5 rounded-full">
                                                {{ $sale->status_transaksi }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4 text-center">
                                            <a href="{{ route('history.show', $sale->id) }}"
                                                class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-indigo-300 transition">
